      ...
      <Card className="bg-gray-800 border-0">
        ...
        <CardContent className="space-y-4">
          {[
            ...
            { subject: 'Chemistry', progress: 72, color: 'bg-blue-500' },
            { subject: 'Physics', progress: 68, color: 'bg-purple-500' },
            { subject: 'CARS', progress: 75, color: 'bg-yellow-500' }
          ].map(subject => (
            <div key={subject.subject}>
              ...
              <Progress value={subject.progress} className="h-2 bg-gray-700" indicatorClassName={subject.color} />
            </div>
          ))}
        </CardContent>
      </Card>
      ...
      <div className="bg-gray-800 border-b border-gray-700 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <Progress value={60} className="w-32 h-2 bg-gray-700" indicatorClassName="bg-blue-500" />
              </div>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Progress value={75} className="w-40 h-3 bg-gray-700" indicatorClassName="bg-green-500" />
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mt-6 grid grid-cols-4 gap-4">
          {[
            ...
            { name: 'Practice Test', icon: Brain, color: 'bg-purple-500', section: 'practicetest' },

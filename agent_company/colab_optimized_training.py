# ================================================================
# OPTIMIZED FFN-v2 Training for Google Colab
# ================================================================
# Based on the working version that successfully trained
# Copy and paste this entire script into a Colab cell and run!
# Make sure to set Runtime → Change runtime type → GPU first
# ================================================================

print("🚀 OPTIMIZED FFN-v2 Training for Google Colab")
print("=" * 50)
...
# ================================================================
# Step 3: Create optimized FFN-v2 model
# ================================================================

print("\n🏗️  Step 3: Creating optimized FFN-v2 model...")
...
print("\n📊 Step 4: Creating high-quality training data...")
...
# ================================================================
# Step 5: Set up optimized training
# ================================================================

print("\n🎯 Step 5: Setting up optimized training...")
...
# ================================================================
# Step 6: Optimized training loop
# ================================================================
...
# ================================================================
# Step 8: Save optimized model and results
# ================================================================

print("\n💾 Step 8: Saving optimized results...")
...
try:
    ...
    }, '/content/ffn_v2_optimized_model.pt')
    
    print("✅ Optimized model saved to /content/ffn_v2_optimized_model.pt")
    ...
    # Model architecture
    plt.subplot(2, 3, 5)
    plt.text(0.1, 0.8, 'Optimized FFN-v2:', fontsize=12, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('/content/ffn_v2_optimized_training_results.png', dpi=300, bbox_inches='tight')
    plt.show()
    
    print("📈 Comprehensive training results saved to /content/ffn_v2_optimized_training_results.png")
...
print(f"📉 Loss reduction: {loss_reduction:.1f}%")
print(f"🏆 Best loss: {best_loss:.6f}")
print(f"💾 Model saved: /content/ffn_v2_optimized_model.pt")
print(f"📈 Results plot: /content/ffn_v2_optimized_training_results.png")

print("\n📥 To download your optimized model:")
print("from google.colab import files")
print("files.download('/content/ffn_v2_optimized_model.pt')")
print("files.download('/content/ffn_v2_optimized_training_results.png')")

print("\n🎯 Your optimized FFN-v2 model is ready for neuron tracing! 🧠")
print("This model features advanced architecture and training techniques.") 
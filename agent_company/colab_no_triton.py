# ================================================================
# FFN-v2 Training for Google Colab (No Triton Conflicts)
# ================================================================
# This script avoids PyTorch Triton library conflicts
# Copy and paste this entire script into a Colab cell and run!
# Make sure to set Runtime → Change runtime type → GPU first
# ================================================================

print("🚀 FFN-v2 Training for Google Colab (No Triton Conflicts)")
print("=" * 60)

# ================================================================
# Step 1: Set environment variables to avoid conflicts
# ================================================================
...
try:
    # Import torch with specific settings
    import torch
    ...
    # Try importing without certain features
    try:
        import torch
...
# ================================================================
# Step 3: Check GPU without Triton
# ================================================================
...
# ================================================================
# Step 4: Create simple FFN-v2 model
# ================================================================
...
class SimpleFFNv2(nn.Module):
    def __init__(self):
        super().__init__()
        # Simple 3D CNN without complex features
...
def create_simple_data(batch_size=4, size=32):
...
try:
    test_volumes, test_labels = create_simple_data(2, 32)
...
try:
    ...
    for epoch in range(num_epochs):
        ...
        # Generate batch
        volumes, labels = create_simple_data(batch_size, volume_size)
...
try:
    ...
    }, '/content/ffn_v2_no_triton_model.pt')
    
    print("✅ Model saved to /content/ffn_v2_no_triton_model.pt")
    
    # Create simple plot
    plt.figure(figsize=(10, 6))
    plt.plot(train_losses, 'b-', linewidth=2)
    plt.title('FFN-v2 Training Loss (No Triton)', fontsize=14, fontweight='bold')
    plt.xlabel('Epoch', fontsize=12)
    plt.ylabel('Loss', fontsize=12)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig('/content/ffn_v2_no_triton_training.png', dpi=150, bbox_inches='tight')
    plt.show()
    
    print("📈 Training plot saved to /content/ffn_v2_no_triton_training.png")
...
print("✅ FFN-v2 TRAINING COMPLETED (No Triton Conflicts)!")
print("=" * 60)
print(f"🎮 Device used: {device}")
print(f"📊 Model parameters: {total_params:,}")
print(f"⏱️  Training time: {total_time:.1f} seconds")
print(f"📉 Loss reduction: {loss_reduction:.1f}%")
print(f"💾 Model saved: /content/ffn_v2_no_triton_model.pt")
print(f"📈 Training plot: /content/ffn_v2_no_triton_training.png")

print("\n📥 To download your trained model:")
print("from google.colab import files")
print("files.download('/content/ffn_v2_no_triton_model.pt')")
print("files.download('/content/ffn_v2_no_triton_training.png')")

print("\n🎯 Your FFN-v2 model is ready for neuron tracing! 🧠")
print("This model was trained without Triton conflicts.") 